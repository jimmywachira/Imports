@extends('layouts.app', ['title' => 'Inspection Reports - Xplore Car Imports', 'description' => 'Understand our vehicle inspection reports with detailed checks, photos, and grading for Japanese import cars in Kenya.'])

@section('content')
<div class="page-shell">
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div class="text-center mb-8 sm:mb-12 lg:mb-16">
            <p class="uppercase tracking-[0.2em] text-xs font-semibold text-amber-400 mb-2 sm:mb-4">Quality Assurance</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        <ion-icon name="checkmark-outline" class="text-amber-400 text-xl sm:text-2xl flex-shrink-0 mt-0.5"></ion-icon>
                        <div>
        ...
        <div class="rounded-3xl bg-gradient-to-r from-amber-400 to-yellow-300 text-slate-900 p-6 sm:p-8 shadow-xl mb-6 sm:mb-8">
        ...
        <div class="text-center">
            <a href="{{ route('cars') }}" class="btn-outline-amber btn-sm p-2 text-xs sm:text-sm">Back to Cars Listing</a>
        </div>
    </div>
