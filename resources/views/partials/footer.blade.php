<footer class="bg-slate-100 backdrop-blur-2xl border-slate-200  py-8 sm:py-12 dark:bg-gradient-to-r dark:from-blue-950 dark:to-blue-900 dark:border-blue-800 dark:text-blue-100">
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
            <!-- Brand -->
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    <div class="w-10 h-10 bg-green-300 rounded-lg flex items-center justify-center flex-shrink-0">
                        <span class="text-blue-900 font-bold text-lg">X</span>
                    </div>
                    <span class="text-lg sm:text-xl font-bold">Xplore Car Imports</span>
                </div>
                <p class="text-black text-xs sm:text-sm dark:text-blue-400">Premium Japanese car imports with full transparency and KEBS compliance.</p>
...
>>>>>>> 3ed648e989eeaac327e55ccd7f01958169ac6a3f
        ...
        <div class="border-t border-slate-200 pt-6 sm:pt-8 dark:border-blue-800">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 text-xs sm:text-sm text-black dark:text-blue-400">
