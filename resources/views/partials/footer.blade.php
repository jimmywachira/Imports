        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    <div class="w-10 h-10 bg-gradient-to-br from-amber-400 to-yellow-300 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2 text-sm sm:text-base">
                    ...
                    <li><a href="{{ route('tradein') }}" class="text-slate-600 hover:text-amber-500 transition dark:text-blue-300 dark:hover:text-amber-400 line-clamp-1">Trade-In Program</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2 sm:space-y-3 text-slate-600 dark:text-blue-300 text-sm sm:text-base">
                    <li class="flex items-start gap-2 sm:gap-3">
                        <ion-icon name="call-outline" class="text-amber-400 flex-shrink-0 mt-0.5 text-base sm:text-lg"></ion-icon>
                        <span class="line-clamp-2">+254 757 356 989</span>
                    </li>
                    <li class="flex items-start gap-2 sm:gap-3">
                        <ion-icon name="mail-outline" class="text-amber-400 flex-shrink-0 mt-0.5 text-base sm:text-lg"></ion-icon>
                        <a href="mailto:info@xplorecar.com" class="line-clamp-2 text-slate-600 hover:text-amber-500 transition dark:text-blue-300 dark:hover:text-amber-400">info@xplorecar.com</a>
                    </li>
                    <li class="flex items-start gap-2 sm:gap-3">
                        <ion-icon name="location-outline" class="text-amber-400 flex-shrink-0 mt-0.5 text-base sm:text-lg"></ion-icon>
        ...
        <div class="border-t border-slate-200 pt-6 sm:pt-8 dark:border-blue-800">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 text-xs sm:text-sm text-slate-500 dark:text-blue-400">
                ...
                <div class="flex gap-2 sm:gap-4 justify-start sm:justify-center flex-wrap">
                    <a href="{{ route('privacy') }}" class="hover:text-amber-400 transition line-clamp-1">Privacy Policy</a>
                    <a href="{{ route('terms') }}" class="hover:text-amber-400 transition line-clamp-1">Terms of Service</a>
                </div>
