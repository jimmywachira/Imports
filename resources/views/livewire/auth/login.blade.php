...
@section('content')
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-green-400 to-green-300 mb-4 shadow-xl">
        ...
        <!-- Login Card -->
        <div class="rounded bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl p-8">
            <!-- Session Status -->
            ...
            <form method="POST" action="{{ route('login.store') }}" class="space-y-6">
                ...
                <!-- Email Address -->
                <div>
                    <label for="email" class="block text-blue-100 mb-2">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        <label for="password" class="block text-blue-100">
                            <ion-icon name="lock-closed-outline" class="align-middle mr-1"></ion-icon>
                            Password
                        </label>
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-xs text-green-300 hover:text-green-200 transition-colors" wire:navigate>
                                Forgot password?
                            </a>
                        @endif
                    </div>
                ...
                <div class="flex items-center">
                    <flux:checkbox 
                        ...
                        class="text-green-400 focus:ring-green-500"
                    />
                ...
                <flux:button 
                    variant="primary" 
                    type="submit" 
                    class="w-full bg-gradient-to-r from-green-400 to-green-300 hover:from-green-500 hover:to-green-400 text-blue-900 font-bold py-3 rounded-b shadow-lg hover:shadow-xl transition-all duration-300"
            ...
            @if (Route::has('register'))
                <div class="mt-6 pt-6 border-t border-white/10 text-center">
                    <p class="text-blue-200 text-sm">
                        ...
                        <a href="{{ route('register') }}" class="text-green-300 hover:text-green-200 font-semibold transition-colors ml-1" wire:navigate>
                            Create an account
                        </a>
                    </p>
                </div>
