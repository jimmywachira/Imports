            ...
            <div class="flex items-center gap-3 mb-4">
                ...
                <nav class="text-sm text-slate-400">
                    <ol class="flex items-center gap-2">
                        ...
                        <li class="text-white font-medium">Create New</li>
                    </ol>
                </nav>
            </div>
            <div class="space-y-2">
                ...
                <p class="text-slate-400 text-sm sm:text-base flex items-center gap-2">
                    ...
                    <span>Fill in the details below to add a new vehicle to your inventory</span>
                </p>
            </div>
        </header>
        ...
        <form wire:submit="save" class="space-y-6 lg:space-y-8">
            ...
            <div class="glass-panel p-5 sm:p-6 rounded-xl backdrop-blur-xl">
                ...
                <p class="text-xs text-slate-400 text-center mt-4">
                    ...
                    All information will be saved securely after submission
                </p>
            </div>
        </form>
    </div>
