<div class="min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 text-slate-100">
    <div class="max-w-4xl mx-auto px-6 py-12">
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-300">Fill in the details below to add a new vehicle to your inventory</p>
        </div>

        <!-- Form -->
        <form wire:submit="save" class="rounded-2xl bg-white/10 border border-white/10 backdrop-blur p-6 md:p-8">
            <div class="space-y-6">
                <!-- VIN Number -->
