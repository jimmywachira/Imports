<div class="page-shell bg-linear-to-br from-blue-500 via-white to-blue-50 dark:from-blue-950 dark:via-blue-900 dark:to-blue-950 min-h-screen">
    <div class="w-4/5 mx-auto px-4 sm:px-6 py-8 sm:py-12">
            ...
            <div class="flex items-start justify-between flex-wrap gap-4 mb-6">
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.vehicles.index') }}" 
                       class="w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-blue-800 border-2 border-blue-200 dark:border-slate-700 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-700 hover:border-blue-400 transition-all duration-200 shadow-sm">
                        <ion-icon name="arrow-back-outline" class="text-xl"></ion-icon>
                    </a>
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-1">Edit Vehicle</h1>
                        <p class="text-sm text-slate-600 dark:text-slate-400 font-medium">{{ $vehicle->full_name }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                    <ion-icon name="car-sport-outline" class="text-blue-600 dark:text-blue-400"></ion-icon>
                    <span class="text-sm font-medium text-blue-700 dark:text-blue-300">VIN: {{ $vehicle->vin_number }}</span>
                </div>
            </div>
        </div>
        ...
        @if (session()->has('message'))
            <div class="mb-6 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border-2 border-green-200 dark:border-green-800 flex items-center gap-3 shadow-sm animate-fade-in">
        ...
        <form wire:submit="update" class="space-y-6">
            ...
            <div class="bg-white dark:bg-blue-800 rounded-2xl border-2 border-blue-100 dark:border-slate-700 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="form-control">
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-blue-900 text-slate-900 dark:text-white placeholder-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200"
                        />
                        @error('vin_number') 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-control">
                            ...
                            <input 
                                ...
                                class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-blue-900 text-slate-900 dark:text-white placeholder-slate-400 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-200"
                            />
                            @error('make') 
                                <span class="flex items-center gap-1 text-red-500 text-sm mt-2">
                                    <ion-icon name="alert-circle" class="text-base"></ion-icon>
            ...
            <div class="bg-white dark:bg-blue-800 rounded-2xl border-2 border-green-100 dark:border-slate-700 shadow-sm overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-control">
                            ...
                            <select 
                                ...
                                class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-blue-900 text-slate-900 dark:text-white focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-200"
                            >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-control">
                            ...
                            <select 
                                ...
                                class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-blue-900 text-slate-900 dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200"
                            >
            ...
            <div class="flex flex-col sm:flex-row gap-4 sticky bottom-4 z-10">
                ...
                <a 
                    ...
                    class="flex-1 sm:flex-none px-8 py-4 rounded-xl border-2 border-slate-300 dark:border-slate-600 bg-white dark:bg-blue-800 hover:bg-blue-50 dark:hover:bg-blue-700 text-slate-700 dark:text-slate-300 font-semibold text-lg transition-all duration-200 flex items-center justify-center gap-3"
                >
