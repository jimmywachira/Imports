...
<div class="page-shell">
    ...
    <div class="relative w-full min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] overflow-hidden flex items-center justify-center mb-8 sm:mb-12 lg:mb-16">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute top-0 right-0 w-96 h-96 bg-green-400/5 rounded-full filter blur-3xl opacity-50"></div>
        </div>

        {{-- Content Container --}}
        <div class="relative z-10 w-4/5 mx-auto px-3 sm:px-6 lg:px-8 py-12 sm:py-20 lg:py-32 text-center">
            {{-- Badge --}}
            <div class="inline-block mb-4 sm:mb-6">
                <p class="uppercase tracking-[0.3em] text-xs font-bold text-green-300 bg-green-400/20 px-4 sm:px-6 py-2 rounded-full backdrop-blur-sm border border-green-400/40 transition-all hover:bg-green-400/30">
            ...
            <h1 class="text-3xl sm:text-5xl lg:text-7xl font-black mb-4 sm:mb-6 leading-tight text-white drop-shadow-lg">
                <span class="bg-gradient-to-r from-green-300 via-green-200 to-green-400 bg-clip-text text-transparent">Making car importation</span>
                <br class="hidden sm:block" />
                <span class="text-white">easy, transparent, and stress-free</span>
                <br class="hidden sm:block" />
                <span class="text-green-300">for every Kenyan</span>
            </h1>
...
<<<<<<< HEAD
                <a href="{{ route('cars') }}" class="bg-green-500 hover:bg-green-600 text-white hover:shadow-xl hover:shadow-green-400/30 transition-all transform hover:scale-105 px-6 py-3 rounded-lg flex items-center justify-center gap-2">
                    <ion-icon name="car-outline" class="text-lg"></ion-icon>
                    Browse Our Vehicles
                </a>
                <a href="{{ route('contact') }}" class="bg-green-400 hover:bg-green-500 px-6 py-3  border-white/40 text-white transition-all transform hover:scale-105 backdrop-blur-sm">
=======
...
>>>>>>> 3ed648e989eeaac327e55ccd7f01958169ac6a3f
        ...
        <div class="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-10 animate-bounce">
            <ion-icon name="chevron-down-outline" class="text-2xl text-green-300 opacity-70"></ion-icon>
        </div>
    </div>
    ...
    <div class="w-4/5 mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6">
            <div class="glass-panel p-4 sm:p-6 text-center">
                <p class="text-2xl sm:text-3xl font-bold text-green-400 mb-1 sm:mb-2">1+</p>
                <p class="ui-muted text-xs sm:text-sm">Years in Business</p>
            </div>
            <div class="glass-panel p-4 sm:p-6 text-center">
                <p class="text-2xl sm:text-3xl font-bold text-green-400 mb-1 sm:mb-2">10+</p>
            ...
            <div class="glass-panel p-4 sm:p-6 text-center">
                <p class="text-2xl sm:text-3xl font-bold text-green-400 mb-1 sm:mb-2">200+</p>
                <p class="ui-muted text-xs sm:text-sm">Drivers Trained</p>
            </div>
            <div class="glass-panel p-4 sm:p-6 text-center">
                <p class="text-2xl sm:text-3xl font-bold text-green-400 mb-1 sm:mb-2">100+</p>
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div class="text-center mb-8 sm:mb-12">
            <h2 class="text-2xl text-green-500 sm:text-3xl lg:text-4xl font-bold">Our Story</h2>
            <p class="ui-muted mt-2 text-sm sm:text-base">Helping Kenyans Drive Their Dream Cars and Own a Stabilized Taxi Business</p>
        </div>

        <div class="max-w-4xl mx-auto glass-panel rounded-3xl p-4 sm:p-6 lg:p-12">
            ...
            <div class="flex justify-center p-4 sm:p-6 lg:p-8">
                <a href="https://youtu.be/feO-u_WJjog?si=WusDX_6oR6UZO6Ep" target="_blank" class="btn-outline-green text-sm sm:text-base">
                    <ion-icon name="logo-youtube" size="large" class="text-lg text-red-600 sm:text-xl"></ion-icon>
                    Watch on YouTube
                </a>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div class="text-center mb-8 sm:mb-12">
            <h2 class="text-2xl text-green-500 sm:text-3xl lg:text-4xl font-bold">Our Core Values</h2>
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div class="text-center mb-8 sm:mb-12">
            <h2 class="text-2xl sm:text-3xl text-green-500 lg:text-4xl font-bold">Why Choose Xplore Imports</h2>
    ...
    <!-- FAQ Section -->
        <div class="mt-8 sm:mt-12 lg:mt-16 rounded-3xl glass-panel p-6 sm:p-8 lg:p-12">
            <div class="text-center mb-8 sm:mb-12">
                <p class="uppercase tracking-[0.2em] text-xs font-semibold text-green-400 mb-2 sm:mb-4">Questions?</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">01</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">02</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">04</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">05</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">06</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">07</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">08</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">09</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">10</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">11</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">12</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">13</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">14</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">15</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">16</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">17</span>
                ...
                <details class="group rounded-2xl border border-slate-200/60 bg-white/70 p-5 transition hover:border-green-400/50 dark:bg-slate-900/40 dark:border-white/10">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-4">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-green-400/20 text-green-300 text-sm font-semibold">18</span>
    ...
    {{-- CTA Section --}}
    <div class="w-full px-3 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 text-center">
        <div class=" bg-gradient-to-r from-green-400 to-green-300 text-lime-900 p-6 sm:p-8 shadow-xl">
...
<<<<<<< HEAD
            <a href="{{ route('cars') }}" class="btn-ink p-4 hover:bg-green-500 btn-lg text-sm sm:text-base">Browse Our Inventory</a>
=======
